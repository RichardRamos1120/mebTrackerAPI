...
app.post('/', async (req, res,next) => {
    ...
    const newsouthsudan = new southsudan({latitude, longitude, Food, Housing, Healthcare, Transportation, Education, Utilities, Clothing, PersonalCare, Communication, Savings, Other, Month, Year});
