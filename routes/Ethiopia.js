...
app.post('/', async (req, res,next) => {
    ...
    const newethiopia = new ethiopia({latitude, longitude, Food, Housing, Healthcare, Transportation, Education, Utilities, Clothing, PersonalCare, Communication, Savings, Other, Month, Year});
