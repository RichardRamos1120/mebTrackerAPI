...
app.post('/', async (req, res,next) => {
    ...
    const newsomalia = new somalia({latitude, longitude, Food, Housing, Healthcare, Transportation, Education, Utilities, Clothing, PersonalCare, Communication, Savings, Other, Month, Year});
