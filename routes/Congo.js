...
app.post('/', async (req, res,next) => {
    ...
    const newcongo = new congo({latitude, longitude, Food, Housing, Healthcare, Transportation, Education, Utilities, Clothing, PersonalCare, Communication, Savings, Other, Month, Year});
